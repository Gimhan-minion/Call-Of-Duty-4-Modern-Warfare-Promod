...
level.smvmaster=1;
	// sd
	setDvar( "scr_sd_bombtimer", 59 ); // [1->] (seconds)
	...
	setDvar( "scr_sd_roundswitch", 12 ); // [0->] (points)
	...
	setDvar( "scr_dom_roundlimit", 0 ); // [0->] (points)
	setDvar( "scr_dom_roundswitch", 1 ); // [0->] (points)
	setDvar( "scr_dom_scorelimit", 3 ); // [0->] (points)
	...
	setDvar( "scr_war_timelimit", 5 ); // [0->] (minutes)
	...
	setDvar( "scr_playerwelcome", 1 );
	setDvar( "smv_fk_music", 1 );
	setDvar( "smv_end_music", 1 );
	setDvar( "smv_end_musiclength", 30 );
	setDvar( "smv_roundend_1", "endround1" );
	setDvar( "smv_roundend_2", "endround2" );
	setDvar( "smv_roundend_3", "endround3" );
	setDvar( "smv_roundend_4", "endround4" );
	setDvar( "smv_roundend_5", "endround5" );
	setDvar( "smv_roundend_6", "endround6" );
	setDvar( "smv_roundend_7", "endround7" );
	setDvar( "smv_roundend_8", "endround8" );
	setDvar( "smv_roundend_9", "endround9" );
	setDvar( "smv_roundend_10", "endround10" );

	setDvar( "smv_gameend_1", "smv_sound1" );
	setDvar( "smv_gameend_2", "smv_sound2" );
	setDvar( "smv_gameend_3", "smv_sound3" );
	setDvar( "smv_gameend_4", "smv_sound4" );
	...
	setDvar( "promod_mc_message_1", "^2Visit ^3smvhost.in" );
	setDvar( "promod_mc_message_2", "" );
	setDvar( "promod_mc_message_3", "" ); //<*nextmap*>
	setDvar( "promod_mc_messagedelay_1", 20 ); // [1->] (overrides default delay in seconds between messages, e.g special messages)
	setDvar( "promod_mc_messagedelay_2", 20 );
	setDvar( "promod_mc_messagedelay_3", 20 );
}
